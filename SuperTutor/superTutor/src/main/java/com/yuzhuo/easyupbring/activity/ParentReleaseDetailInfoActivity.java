...
public class ParentReleaseDetailInfoActivity extends BaseAct {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.act_parent_release_detail_info);
	...
	void createCollect(final UpBringBean upBringBean) {
		...
		net.doGet(new NetTask(context) {
			...
			public void doInUI(Response response, Integer transfer) {
				...
				Toast.makeText(ParentReleaseDetailInfoActivity.this, message,
